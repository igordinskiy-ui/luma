...
export function ConsentRenewal({ onDone, legalVersion, legalDigest }: { onDone: () => void } & LegalIdentityProps) {
  ...
  return <main className="path-page path-form-page">
    ...
    <form className="path-form-card" onSubmit={submit}>
      ...
      <label className="path-consent"><input name="consent" type="checkbox" required /><span>Я принимаю <a href="/terms.html" target="_blank" rel="noreferrer">условия использования</a>, ознакомился с <a href="/privacy.html" target="_blank" rel="noreferrer">политикой</a> и даю <a href="/consent.html" target="_blank" rel="noreferrer">согласие на обработку данных</a>.</span></label>
